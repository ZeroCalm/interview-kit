...
> "Strategy defined and saved. Please review the strategy doc. If it looks correct, we can move on to the next phase. I am now invoking `@[/interview-planning]`."
