...
5. Write the result as a clean standalone Markdown document for one question file such as `answer-bank/Q1.md`.
6. Keep the output dense and skimmable. Prefer interview-ready wording over explanatory wording.
7. `Expression Practice` must stay drill-oriented: short rewrites, opening lines, sharper judgment sentences, or compression hints. Do not turn it into essay coaching.
